...
<body>
    ...
    <div class="container">
    <?php
    $sql1 = "SELECT count(order_id) as count1 from orders where order_status=2";
    ...
    ?>
        ...
        $sql = "select * from orders where order_status='2' order by order_id desc";
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <div class="menu" style="display:flex; ">
                ...
                <div style="width:500px; height:330px;background-color: #ffff66">
                ...
                <div style="width:300px; height:330px ;background-color: #ffff66">
                <a href="update_order1.php?order_id=<?php echo $row["order_id"]; ?>"><input style="margin-top:10px;" type=submit class=button value="Accept"></a>
