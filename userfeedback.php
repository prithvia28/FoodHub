...
<body>
    ...
    <div class="container">
        ...
        $sql = "select * from orders where user_id='$user_id' and order_status='5' order by order_id desc";
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <div class="menu" style="display:flex; ">
                ...
                <a href="feed.php?order_id=<?php echo $row["order_id"]; ?>"><input style="margin-top:  20px;" type="submit" class="button" value="Give Feedback" /></a>
