...
<body>
    ...
    <div class="container">
        ...
        $sql = "select * from orders where user_id='$user_id' and order_status in ('2','3','4') order by order_id desc";
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <div class="menu" style="display:flex; ">
                ...
                <div style="width:300px; height:300px ;background-color: #ffff66">
                    ...
                    <h4>Order status: <em>Order sent. </em></h4>
                ...
                <?php
                        ...
                        <h4>Order status: <em>Received. Preparing your order. </em></h4>

                    <?php
                        }
                        elseif ($order == 4) {
                            ?>
                        <h4>Order status:<em> Order ready.</em></h4>
