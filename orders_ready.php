...
<body>
    ...
    ?>
        ...
        $sql = "select * from orders where order_status='3' order by order_id desc";
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <div class="menu" style="display:flex; ">
                ...
                <a href="update_order2.php?order_id=<?php echo $row["order_id"]; ?>"><input style="margin-top:10px;" type=submit class=button value="Ready"></a>
